// ─────────────────────────────────────────
// Screen: CustomDishRequestScreen
// Description: Form for buyers to request a custom dish from a chef.
//              Captures description, dietary needs, budget, and timing.
// Contains: Request form, Firestore submission, chef notification
// ─────────────────────────────────────────
...
class CustomDishRequestScreen extends StatefulWidget {
  ...
  const CustomDishRequestScreen(
      {super.key, required this.chefId, required this.chefName});

  @override
  State<CustomDishRequestScreen> createState() =>
      _CustomDishRequestScreenState();
}
              ...
              child: Column(
                children: [
                  _buildInput(
                    ...
                    validator: (value) =>
                        value!.isEmpty ? 'dish_name_required'.tr() : null,
                  ...
                  _buildInput(
                    ...
                    validator: (value) =>
                        value!.isEmpty ? 'ingredients_required'.tr() : null,
                    maxLines: 3,
                    ...
                    children: [
                      Expanded(
                        child: _buildInput(
                          ...
                          onSaved: (val) =>
                              _servings = int.tryParse(val ?? '1') ?? 1,
