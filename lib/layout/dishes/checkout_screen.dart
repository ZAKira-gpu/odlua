...
// Description: Order review and payment — shows cart summary, delivery
//              details, and payment method selection before placing.
// Contains: Cart list, price breakdown, payment selector, order submit
// ─────────────────────────────────────────
  ...
  Widget _buildPaymentOption({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          color: isSelected ? mainColor.withValues(alpha: 0.1) : Colors.white,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
